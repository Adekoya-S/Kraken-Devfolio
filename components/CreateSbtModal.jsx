        ...
        <div className="rex3 bg-[#1c1c1c]  p-10 rounded-[40px] w-full mx-[380px] py-24">
          <div>
            ...
            <form className="flex flex-col" noValidate autoComplete="off">
              ...
              <input
                type="text"
                className="border gradi text-sm border-secondary-white p-2 rounded mb-5"
              ...
              <input
                type="text"
                className="border text-sm border-secondary-white gradi p-2 rounded mb-5"
              ...
              <input
                ...
                min="0.001"
                step="0.001"
                className="border border-secondary-white p-2 rounded mb-5 text-sm gradi"
